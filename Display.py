...
for (x, y, w, h) in fa:
    ...
    if final == 1:
        cv2.putText(image, "Le Duong Bao Lam",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 2:
        cv2.putText(image, "Hieu thu hai ",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 3:
        cv2.putText(image, "Ngo Kien Huy",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 4:
        cv2.putText(image, "Cris Phan",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
